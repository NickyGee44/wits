...
export interface QuillAndInkInterface extends utils.Interface {
  functions: {
    ...
    "initialize(bytes32,address,uint256,address[],uint256[])": FunctionFragment;
...
export interface QuillAndInk extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: QuillAndInkInterface;
  ...
  functions: {
    ...
    initialize(
      whitelistMerkleTreeRoot_: PromiseOrValue<BytesLike>,
      royaltiesRecipient_: PromiseOrValue<string>,
      royaltiesValue_: PromiseOrValue<BigNumberish>,
