...
export interface AdminManagerUpgradableInterface extends utils.Interface {
  functions: {
...
export interface AdminManagerUpgradable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdminManagerUpgradableInterface;
