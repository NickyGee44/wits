...
export interface SupplyUpgradableInterface extends utils.Interface {
  functions: {
...
export interface SupplyUpgradable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SupplyUpgradableInterface;
