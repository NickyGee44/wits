...
export interface AdminMintUpgradableInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "adminMint" | "isAdmin" | "setAdminPermissions"
  ): FunctionFragment;
...
export interface AdminMintUpgradable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdminMintUpgradableInterface;
