...
export interface CustomPaymentSplitterUpgradeableInterface
...
export interface CustomPaymentSplitterUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CustomPaymentSplitterUpgradeableInterface;
