...
abstract contract ERC1155PermitUpgradeable is Initializable, ERC1155BurnableUpgradeable, EIP712Upgradeable, IERC1155Permit, IImmutableERC1155Errors {
    ...
    function __ERC1155PermitUpgradeable_init(
        string memory _name,
        string memory _uri
