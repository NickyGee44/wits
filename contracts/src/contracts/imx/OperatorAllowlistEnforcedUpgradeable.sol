...
// Allowlist Registry
import { IERC165 } from "@openzeppelin/contracts/access/AccessControlEnumerable.sol";

// Access Control
import "@openzeppelin/contracts-upgradeable/access/AccessControlEnumerableUpgradeable.sol";

// Errors
import {OperatorAllowlistEnforcementErrors} from "@imtbl/contracts/contracts/errors/Errors.sol";
...
abstract contract OperatorAllowlistEnforcedUpgradeable is AccessControlEnumerableUpgradeable, OperatorAllowlistEnforcementErrors {
    ///     =====   State Variables  =====
    ...
    function __OperatorAllowlistEnforced_init_unchained() internal initializer {
