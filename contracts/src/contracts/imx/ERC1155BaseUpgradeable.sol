...
import "./OperatorAllowlistEnforcedUpgradeable.sol";
    ...
    ERC2981Upgradeable 
{
    ...
    function __ERC1155BaseUpgradeable_init(
        address owner,
        string memory name_,
        ...
        __ERC1155PermitUpgradeable_init(name_, baseURI_);
        __ERC2981_init_unchained();
        __OperatorAllowlistEnforced_init_unchained();
    ...
    */
     ...
     */
    function setApprovalForAll(address operator, bool approved) public override(ERC1155Upgradeable) validateApproval(operator) {
    ...
    function supportsInterface(
        ...
        view
        virtual
        override(ERC1155PermitUpgradeable, ERC2981Upgradeable, OperatorAllowlistEnforcedUpgradeable)
        returns (bool)
    {
